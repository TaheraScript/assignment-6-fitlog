            ...
            <div>
              ...
              <div className="flex gap-2 mt-4">
                {data.muscleGroups.map((muscle, index) => (
                  <div
                    key={index}
                    className="badge font-inter font-bold text-[11px] rounded-4xl bg-[#ccff00] text-black  px-3 py-1"
                  >
                    {muscle}
                  </div>
                ))}
              ...
              <div className="mt-6 bg-[#151922] rounded-xl divide-y divide-[#1E2330]">
                {specs.map((spec) => (
                  ...
                  >
                    <span className="text-[#9CA3AF] font-bold text-[12px]  font-inter tracking-wide">
                      {spec.label}
                    </span>
                    <span className="text-[#E5E7EB] font-medium text-14 font-inter">
                      {spec.value}
                    </span>
                  </div>
                ))}
